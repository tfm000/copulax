...
- The `tests/` directory (legacy suite) remains in-tree pending deletion of its remaining Medium/Low audit items; new tests must go to `tests_new/`. See `.claude/test_audit/` for the current migration scoreboard.
